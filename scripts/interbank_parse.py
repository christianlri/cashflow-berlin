...
MERCHANT_CATEGORY = [
    ...
    ("movistar",          "Network"),
    ("vodafone",          "Network"),
    ("amznprime",         "Subscription"),
    ("amazon prime",      "Subscription"),
    ("amazon",            "Online Shopping"),
    ("amzn",              "Online Shopping"),
    ("kindle svcs",       "Online Shopping"),
    ("temu",              "Online Shopping"),
    ("catawiki",          "Online Shopping"),
    ...
    ("zoo palast",        "Entertainment"),
    ("zoopalast",         "Entertainment"),
    ("theater",           "Entertainment"),
    ("eventim",           "Entertainment"),
    ("timebandits",       "Entertainment"),
    ("premium entertainm", "Entertainment"),
    ("dazn",              "Entertainment"),
    ("ikea",              "Housing"),
    ("zara",              "Clothing"),
    ("h&m",               "Clothing"),
